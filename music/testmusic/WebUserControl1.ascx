...
<div class="login-page">
  ...
  <asp:RequiredFieldValidator runat="server" ControlToValidate="password" Text=" Password không được trống" ForeColor="Red"></asp:RequiredFieldValidator>
    ...
    <asp:RequiredFieldValidator runat="server" ControlToValidate="Name" Text="Tên không được trống" ForeColor="Red"></asp:RequiredFieldValidator>
   ...
   Text="* Không đúng định dạng email"  ForeColor="Red"/>
          <asp:RequiredFieldValidator runat="server" ControlToValidate="email" Text="Email không được trống" ForeColor="Red"></asp:RequiredFieldValidator>
       <asp:TextBox ID="ngaysinh" runat="server" placeholder="Ngày Sinh" CssClass="textbox"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ControlToValidate="ngaysinh" Text="Ngày sinh không được trống" ForeColor="Red"></asp:RequiredFieldValidator>
   ...
   Text="*Định dạng ngày sinh phải ở dạng mm/dd/yyyy"  ForeColor="Red"/>
                 <p> Giới tính</p>
